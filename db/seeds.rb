...
devschool1 = DevSchool.new(
    ...
    payment_facilities: "AGECIL / FIP PLE, CSP, Transition professionnelle, Pledg, CPF (Compte personnel de formation), Pôle emploi, OPCO (Opérateurs de Compétence)",
    certifying: true,
    category: "Full stack",
...
devschool3 = DevSchool.new(
    ...
    payment_facilities: "Pôle emploi, Region HDF, transition PRO, CPF (Compte personnel de formation)",
    certifying: true,
    category: "Full stack",
...
devschool5 = DevSchool.new(
    ...
    payment_facilities: "Pôle emploi, OPCO, CPF (Compte personnel de formation)",
    certifying: true,
    category: "Full stack",
